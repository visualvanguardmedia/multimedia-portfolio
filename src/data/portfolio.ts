...
export const portfolioVideos: PortfolioVideo[] = [
  ...
  // Instagram Reels - Visual Vanguard Media Social Content
  {
    ...
    thumbnail: 'https://via.placeholder.com/600x400/0d9488/ffffff?text=Portugal+Marathon',
    duration: '0:30',
  ...
  },
  {
    ...
    thumbnail: 'https://via.placeholder.com/600x400/f97316/ffffff?text=Malice+Pizza',
    duration: '0:35',
    category: 'Commercial',
