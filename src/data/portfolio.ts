...
export const portfolioVideos: PortfolioVideo[] = [
  ...
  // Additional Professional Videos - Expanded Skills Demonstration
  {
    ...
    description: 'High-level podcast production featuring expert interview techniques, professional audio engineering, and seamless post-production workflow. Demonstrates advanced skills in multi-track audio recording, real-time monitoring, and professional podcast standards for long-form content creation.',
    platform: 'youtube',
    ...
    duration: '58:45',
    category: 'Podcast',
    tags: ['Podcast Production', 'Interview Skills', 'Audio Engineering', 'Long-form Content'],
    role: 'Audio Producer & Podcast Engineer',
  ...
  },
  {
    ...
    description: 'Creative motion graphics showcase featuring dynamic animations, professional kinetic typography, and sophisticated visual effects. Demonstrates expertise in After Effects animation principles, brand-consistent design, and engaging social media content optimization.',
    platform: 'instagram',
    ...
    duration: '0:30',
    category: 'Creative',
    tags: ['Motion Graphics', 'Animation', 'After Effects', 'Visual Design'],
