...
export const portfolioVideos: PortfolioVideo[] = [
  ...
  {
    id: '11',
    title: 'Visual Vanguard Media - Behind the Scenes',
    description: 'Behind-the-scenes content showcasing the professional production process and creative workflow of Visual Vanguard Media. Features equipment demonstrations, setup processes, and creative insights that highlight technical expertise and professionalism.',
    platform: 'instagram',
    instagramId: 'C95kfLhyvv9',
    instagramUrl: 'https://www.instagram.com/visual.vanguard.media/reel/C95kfLhyvv9/',
    thumbnail: 'https://via.placeholder.com/600x400/ea580c/ffffff?text=Visual+Vanguard+Media',
    duration: '0:35',
    category: 'Social Media',
    tags: ['Behind the Scenes', 'Production Process', 'Professional Workflow', 'Brand Content'],
    role: 'Content Creator & Producer',
    technologies: ['Multi-cam Setup', 'Professional Equipment', 'Brand Storytelling', 'Social Content'],
    client: 'Visual Vanguard Media',
    year: 2024,
    featured: true,
  }
